function createContactEmailContent(
    ...
    try {
      ...
      const htmlContent = `
        <html>
          <body>
            <h1>Nov kontaktni obrazec na Bauhar.si</h1>
      ...
      const textContent = `
        Nov kontaktni obrazec na Bauhar.si
  ...
  function createReplyToVisitorEmailContent(
    ...
    try {
      const htmlContent = `
        <html>
          <body>
            ...
            <p>Zahvaljujemo se vam za vaše povpraševanje na Bauhar.si.</p>
            <p>Vaše sporočilo smo prejeli in se bomo nanj odzvali v najkrajšem možnem času.</p>
            <p>Lep pozdrav,<br>Ekipa Bauhar.si</p>
          </body>
        </html>
      `;
      ...
      const textContent = `
        ...
        Zahvaljujemo se vam za vaše povpraševanje na Bauhar.si.
