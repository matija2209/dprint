export default function SchemaMarkup() {
    ...
    const organizationSchema = {
      ...
      '@type': 'Organization',
      name: 'Bauhar d.o.o.',
      url: 'https://www.bauhar.si',
      logo: 'https://www.bauhar.si/logo.png',
      ...
      vatID: 'SI 20511230',
      email: 'info@bauhar.si',
      telephone: '+38659123456', // Replace with actual phone number
      sameAs: [
        'https://www.facebook.com/bauhar', // Replace with actual social media URLs
        'https://www.linkedin.com/company/bauhar'
      ],
    ...
    const localBusinessSchema = {
      ...
      name: 'Bauhar d.o.o.',
      image: 'https://www.bauhar.si/images/office.jpg',
      '@id': 'https://www.bauhar.si',
      url: 'https://www.bauhar.si',
      telephone: '+38659123456', // Replace with actual phone number
      address: {
        '@type': 'PostalAddress',
    ...
    const websiteSchema = {
      ...
      potentialAction: {
        '@type': 'SearchAction',
        target: 'https://www.bauhar.si/search?q={search_term_string}',
